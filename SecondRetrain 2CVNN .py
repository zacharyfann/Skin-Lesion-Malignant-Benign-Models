...
train_df, val_df = train_test_split(df, test_size=0.2, random_state=55)
...
# Separate ImageDataGenerators for different racial groups
# ImageDataGenerator
...
# Train DataLoader
train_data = datagen_default.flow_from_dataframe(
    dataframe=train_df,
    x_col='file_path',
...
val_data = datagen_default.flow_from_dataframe(
    dataframe=val_df,
    x_col='file_path',
    y_col='classification',
    target_size=image_size,
